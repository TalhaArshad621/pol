...
<div class="row page-titles mx-0">
    <div class="col p-md-0">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="/donate-blood">Donate Blood</a></li>
        </ol>
    </div>
</div>
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              ...
              <!-- Multi Columns Form -->
              <form id="donorFound" class="row g-3 none" action="{{ route('donation.store') }}" method="POST">
                @csrf
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form class="row g-3" id="donator-form">
            @csrf
            <input type="hidden" name="app" value="0" id="app">
            <div class="col-md-12">
